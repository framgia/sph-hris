            ...
            modelBuilder.Entity("api.Entities.MultiProject", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 3, 2, 12, 2, 51, 2, DateTimeKind.Local).AddTicks(8766),
                            LeaveId = 1,
                            ProjectId = 1,
                            ProjectLeaderId = 1,
                            Type = "leave",
                            UpdatedAt = new DateTime(2023, 3, 2, 12, 2, 51, 2, DateTimeKind.Local).AddTicks(8767)
                        });
                });
            ...
            modelBuilder.Entity("api.Entities.Overtime", b =>
                {
                    ...
                    b.Property<float?>("ApprovedMinutes")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("api.Entities.LeaveNotification", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 3, 2, 12, 2, 51, 3, DateTimeKind.Local).AddTicks(295),
                            Data = "Some JSON Data",
                            IsRead = false,
                            RecipientId = 70,
                            Type = "leave",
                            UpdatedAt = new DateTime(2023, 3, 2, 12, 2, 51, 3, DateTimeKind.Local).AddTicks(296),
                            LeaveId = 1
                        });
                });
