...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectUndertime", b =>
                {
                    b.Property<int>("ProjectsId")
                        .HasColumnType("int");

                    b.Property<int>("UndertimesId")
                        .HasColumnType("int");

                    b.HasKey("ProjectsId", "UndertimesId");

                    b.HasIndex("UndertimesId");

                    b.ToTable("ProjectUndertime");
                });
            ...
            modelBuilder.Entity("api.Entities.Undertime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectUndertime", b =>
                {
                    ...
                    b.HasOne("api.Entities.Undertime", null)
                        .WithMany()
                        .HasForeignKey("UndertimesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
