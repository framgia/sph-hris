          ...
          <div className="flex w-full max-w-xl flex-col items-center justify-center px-5 py-5">
            ...
            <div className="flex w-full ">
              <button
                ...
                className="relative flex w-full items-center justify-center rounded border border-slate-300 px-6 py-2.5 text-xs font-medium uppercase leading-tight shadow-md transition duration-150 ease-in-out focus:bg-slate-700 focus:shadow-lg focus:outline-none focus:ring-0 hover:shadow-lg  active:shadow-lg"
              >
